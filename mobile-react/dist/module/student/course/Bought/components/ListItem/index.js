define(function (require, exports) {
    ...
    var ListItem = function (_React$Component) {
        ...
        function ListItem() {
            ...
            return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = ListItem.__proto__ || Object.getPrototypeOf(ListItem)).call.apply(_ref, [this].concat(args))), _this), _this.renderFoot = function () {
                var self = _this;
                var _self$props = self.props, courseMode = _self$props.courseMode, courseType = _self$props.courseType, currentCourseCnt = _self$props.currentCourseCnt, liveStatus = _self$props.liveStatus, startTime = _self$props.startTime;
                var html = void 0;
                if (courseMode === _courseMode2.default.SERIES) {
                    html = _react2.default.createElement('div', null, '系列 | 已更新', currentCourseCnt, '节课');
                } else if (courseType === _courseType2.default.RELAY) {
                    html = _react2.default.createElement('div', null, '视频 | 时长', _util2.default.timeShow(self.props.videoLength));
                    ...
                    html = _react2.default.createElement('div', null, '回放生成中');
                } else if (liveStatus === 2) {
                    html = _react2.default.createElement('div', null, '直播 | ', _util2.default.getStartTime(startTime), '上课');
                } else {
                    html = _react2.default.createElement('div', null, '直播回放 | 时长', _util2.default.timeShow(self.props.videoLength));
                }
                return html;
    ...
    ListItem.propTypes = {
        ...
        videoLength: _react.PropTypes.number,
        planCourseCnt: _react.PropTypes.number,
        currentCourseCnt: _react.PropTypes.number
    };
