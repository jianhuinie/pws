...
define('module/detail/courseList/services',[],function () {
 ...
 * @author niejianhui
 */
define('module/detail/courseList/one2one/controller',[],function () {
    'use strict';
 ...
 * @author wangyujie
 */
define('module/detail/courseList/videoCourse/controller',['require','cc/util/localStorage'],function (require) {
    ...
    function Controller($scope, courseListService, $state, tipsService, utilService) {
        ...
        function initView() {
            ...
            $scope.addWaterMarkUrl = 'http://www.genshuixue.com/video_course/editwatermark';
...
define('module/detail/courseList/controllers',['require','./services','./one2one/controller','./videoCourse/controller'],function (require) {
    'use strict';
    require ('./services');
...
define('module/detail/courseList/app',['require','./controllers'],function (require) {
    'use strict';
...
define('module/detail/cloudPlayback/service',[],function () {
 ...
 * @author niejianhui
 */
define('module/detail/selectVideoDialog/controller',[],function () {
    'use strict';
    function Controller($rootScope, $scope, $sce, utilService) {
        function initView() {
            ...
            if (env === 'www') {
                iframeUrl = 'http://' + str;
                // iframeUrl = 'http://0.0.0.0:8108/commonPage.html?fileType=video&hideUpload=true&noMultiple=true&hideSettings=true&auth_token=' + $rootScope.user.auth_token + '#/dataBank';
            }
            else {
 ...
 * @author niejianhui
 */
define('module/detail/cloudPlayback/addVideoDialog/controller',['require','module/detail/selectVideoDialog/controller'],function (require) {
    'use strict';
 ...
 * @author niejianhui
 */
define('module/detail/cloudPlayback/editExpireDateDialog/controller',['cc-config/form/Validator'],function () {
    'use strict';
 ...
 * @author niejianhui
 */
define('module/detail/cloudPlayback/closePlaybackDialog/controller',[],function () {
    'use strict';
...
define('module/detail/cloudPlayback/controller',['require','./service','common/config/common','module/detail/cloudPlayback/addVideoDialog/controller','module/detail/cloudPlayback/editExpireDateDialog/controller','module/detail/cloudPlayback/closePlaybackDialog/controller'],function (require) {
    'use strict';
    require('./service');
    var config = require('common/config/common');
...
define('module/detail/cloudPlayback/app',['require','./controller'],function (require) {
    'use strict';
    require('./controller');
...
define('module/detail/module',['require','bindonce','ng-sanitize','common/ngService/main','common/ngDirective/main','common/ngFilter/main','module/detail/courseList/app','module/detail/cloudPlayback/app'],function (require) {
    'use strict';
    require('bindonce');
    require('ng-sanitize');
 ...
 * @author niejianhui
 */
define('module/detail/app', ['require','cc-config/form/Validator','../../common/ngService/main','./module'],function (require) {
    'use strict';
    // 公共校验配置
