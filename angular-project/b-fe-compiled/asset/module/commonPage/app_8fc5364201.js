                        ...
                        if (buttonStatus === 'BEFORE') {
                            ...
                            item.remindTipOptions = {
                                ...
                                content: '课前4小时内可以进入，如需提前备课或上传课件，请通过直播助手进入'
                                         + '<a href="http://' + $scope.env + '.genshuixue.com/live/teacher_trial?number='
...
define('module/commonPage/studentLive/playback/controller',['require','module/commonPage/studentLive/playback/selectPlaybackDialog/controller'],function (require) {
    'use strict';
    function Controller($scope, studentLiveServices, utilService, dialog) {
    ...
    Controller.$inject = ['$scope', 'studentLiveServices', 'utilService', 'dialog'];
