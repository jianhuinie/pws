    ...
    !function (a, b) {
        ...
        var t = function (a) {
            ...
            function ya(a, b) {
                var c = b.length > 0, e = a.length > 0, f = function f(_f, g, h, i, k) {
                        var l, m, o, p = 0, q = '0', r = _f && [], s = [], t = j, u = _f || e && d.find.TAG('*', k), v = w += null == t ? 1 : Math.random() || 0.1, x = u.length;
        ...
        n.fn.extend({
            ...
            attr: function attr(a, b, c) {
                ...
                if (a && 3 !== f && 8 !== f && 2 !== f)
                    return _typeof(a.getAttribute) === U ? n.prop(a, b, c) : (1 === f && n.isXMLDoc(a) || (b = b.toLowerCase(), d = n.attrHooks[b] || (n.expr.match.bool.test(b) ? Za : Ya)), void 0 === c ? d && 'get' in d && null !== (e = d.get(a, b)) ? e : (e = n.find.attr(a, b), null == e ? void 0 : e) : null !== c ? d && 'set' in d && void 0 !== (e = d.set(a, c, b)) ? e : (a.setAttribute(b, c + ''), c) : void n.removeAttr(a, b));
            },
        ...
        n.offset = {
            ...
            offset: function offset(a) {
                ...
                if (f)
                    return b = f.documentElement, n.contains(b, d) ? (_typeof(d.getBoundingClientRect) !== U && (e = d.getBoundingClientRect()), c = Jb(f), {
