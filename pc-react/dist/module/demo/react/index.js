        ...
        _createClass(ReactDemo, [
            {
                ...
                value: function componentDidMount() {
                    var _this2 = this;
                    _ajaxService2.default.post('/area/list', {}).then(function (res) {
                        _this2.setState({ content: _react2.default.createElement('div', null, res.data[0].name) });
                        return;
                    });
                }
            },
            {
                ...
                value: function render() {
                    return _react2.default.createElement(_component2.default, null);
                }
            }
        ]);
        return ReactDemo;
