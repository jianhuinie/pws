...
<head>
	...
	<link rel="stylesheet/less" href="../css/updateThesis.less" type="text/less">
	<link rel="stylesheet" type="text/css" href="../lib/bootstrap.css">
	<script type="text/javascript" src="../lib/jquery-1.12.2.min.js"></script>
	<script type="text/javascript" src="../common/showPics.js"></script>
	<script type="text/javascript" src="../js/updateThesis.js"></script>
		...
		<div id="box">
			...
			<div id="content">
				...
				<div id="content-right"> 
					...
					<div id="texts">
						<div id="left">
							<div id="updateThesisForm">
								<form method="post">
									<div class="item">
										<label>论文内容:</label>
										<textarea name="thesisContent" id="thesisContent">
										</textarea> 
									</div>
									<div class="item">
										<?php
										$thesisNum = $_GET['thesisNum'];
										echo "<input type='submit'  id='sendNews' value='提交修改'".'onclick="if (validateform()) { form.action='."'./updateThesis1.php?thesisNum=$thesisNum'".'}"> ';
										 ?>
									</div>
								</form>
							</div>
