...
<head>
	...
	<link rel="stylesheet/less" href="../common/notifierDetail.less" type="text/less">
			...
			<div id="content">
				...
				<div id="content-right"> 
					<ul class="breadcrumb">
						...
						<li>
							<a href="notifiers.php">会议通知</a> <span class="divider">/</span>
						</li> 
						<?php
							$notifierNum = $_GET['notifierNum'];
							echo "<li class='active'>会议通知$notifierNum</li>";
						?>	
					</ul>
					...
					<div id="texts">
						<div id="left">
							<?php
							    ...
							    $mysql=mysqli_connect("localhost","2012061516","940710","project") or die("数据库连接失败".mysql_error());
								$mysql->query("set names utf8");
								$sql="select * from notifiers where number='$notifierNum'";
								$query=$mysql->query($sql);
								$row=mysqli_fetch_array($query);
