...
<head>
	...
	<link rel="stylesheet/less" href="../common/newsDetail.less" type="text/less">
				...
				<div id="content-right"> 
					<ul class="breadcrumb">
						...
						<?php
							...
							echo "<li class='active'>会议新闻$newsNum</li>";
						?>	
					</ul>
					...
					<div id="texts">
						<div id="left">
							<?php
							    ...
							    $mysql=mysqli_connect("localhost","2012061516","940710","project") or die("数据库连接失败".mysql_error());
								$mysql->query("set names utf8");
								$sql="select * from news where number='$newsNum'";
								$query=$mysql->query($sql);
								$row=mysqli_fetch_array($query);
