...
<head>
	...
	<link rel="stylesheet/less" href="../common/videoDetail.less" type="text/less">
			...
			<div id="content">
				...
				<div id="content-right"> 
					<ul class="breadcrumb">
						...
						<li>
							<a href="videos.php">会议视频</a> <span class="divider">/</span>
						</li> 
						<?php
							$videoNum = $_GET['videoNum'];
							echo "<li class='active'>会议视频$videoNum</li>";
						?>	
					...
					<div id="texts">
						<div id="left">
							<hr>
							<video width="580" height="340" controls="controls">
								<?php
									$videoNum = $_GET['videoNum'];
									$videoSource = '../videoSources/video'.$videoNum.'.mp4';
