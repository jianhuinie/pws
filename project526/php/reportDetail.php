...
<head>
	...
	<link rel="stylesheet/less" href="../common/reportDetail.less" type="text/less">
			...
			<div id="content">
				...
				<div id="content-right"> 
					<ul class="breadcrumb">
						...
						<li>
							<a href="specialReports.php">特邀报告</a> <span class="divider">/</span>
						</li> 
						<?php
							$reportNum = $_GET['reportNum'];
							echo "<li class='active'>特邀报告$reportNum</li>";
						?>	
					</ul>
					...
					<div id="texts">
						<div id="left">
							<?php
							    ...
							    $mysql=mysqli_connect("localhost","2012061516","940710","project") or die("数据库连接失败".mysql_error());
								$mysql->query("set names utf8");
								$sql="select * from specialreports where number='$reportNum'";
								$query=$mysql->query($sql);
								$row=mysqli_fetch_array($query);
								echo "<div id='title'>".$row['title']."</div>";	
								echo "<hr>";
								echo "<table id='reportInfo' class='table table-bordered'>"; 
								echo "<tr><td>报告标题：</td><td>".$row['title']."</td></tr>";
								echo "<tr><td>报告人：</td><td>".$row['speaker']."</td></tr>";
								echo "<tr><td>所属学科：</td><td>".$row['subject']."</td></tr>";
								echo "<tr><td>报告时间：</td><td>".$row['time']."</td></tr>";
								echo "<tr><td>报告时长：</td><td>".$row['totalTime']."</td></tr>";
								echo "</table>";  
								echo "<div id='title1'>报告详细内容</div>";
