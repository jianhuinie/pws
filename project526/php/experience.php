...
<head>
	...
	<link rel="stylesheet/less" href="../css/experience.less" type="text/less">
	...
	<div id="container">
		<div id="box">
			...
			<div id="nav">
					 ...
					 <a href="experience.php" class="active">经验交流</a>
			...
			<div id="content">
				...
				<div id="content-right"> 
					...
					<div id="texts">
						<div id="left">
							<div class="item">
								<a href="./expDetails/organizeMeeting.php">	         如何组织成功的学术会议？
								</a>	
							</div>
							<div class="item">
								<a href="./expDetails/notes.php">
									《在国外参加学术会议之感慨》
								</a>
							</div>
							<div class="item">
								<a href="./expDetails/prepareMeeting.php">
									如何准备学术会议墙报
								</a>
							</div>
							<div class="item">
								<a href="./expDetails/experiences1.php">	一些筹办国际性学术会议的心得和经验
								</a>
							</div>
							<div class="item">
								<a href="./expDetails/experiences2.php">	参加国际学术会议经验总结
								</a>
							</div>
							<div class="item">
								<a href="./expDetails/experiences1.php">一些筹办国际性学术会议的心得和经验
