...
render(
    "classCourse/tpl0/detail",
    array(
        "tpl_data" => array(
            "teacher" => array(
                "id" => '234'
            ),
            "playback_expire_day" => "",  // 回放有效期
            ...
            "trial_info" => array(
                "feedback_url" => "http://www.baidu.com",
                "is_support_trial" => "true",
                "lesson" => array(
                    "room_no" => "232131231",
                    "online_data" => array(
                        "location" => "http://www.genshuixue.com",
                        "mode" => 0,
                        "token" => "232323",
                        "tiemstamp" => "124578335"
                    )
            ...
            "course_info" => array(
                ...
                "lesson_way" => 4, //可上课的方式 4线下课 2直播课 3在线公开课
                "class_type" => 1,
                "price" => "0.00", //课程价格
                "original_price" => null,
                ...
                "intro" => array(
                    ...
                    "items" => [
                        ...
                        array(
                            ...
                            "storage_id" => 189396,
                            "video_id" => null,
                            "url" => "https://imgs.genshuixue.com/35704717_96dpmcjz.mp3",
                            "cover" => null
                        ),
                         array(
                            "type" => "audio",
                            ...
                            "storage_id" => 189396,
                            "video_id" => null,
                            "url" => "https://imgs.genshuixue.com/35704737_3t5ioqle.mp3",
                            "cover" => null
                        ),
                        array(
                            "type" => "video",
                        ...
                        array(
                            ...
                            "storage_id" => 4097770,
                            "video_id" => null,
                            "url" => "http://img.gsxservice.com/18308345_wda2v4bt.mp3",
                            "cover" => null
                        )
                    ]
                ),
                ...
                "open_status" => 3, //确认开班 1 未确认开班 2 关闭开班 3
                ...
                "chaban_price" => 0,//插班价格
                "retire_flag" => 0, // 退班规则 0.随时可退 2.1小时 3.第几节课 100.不可退
                "retire_length" => 3,
                "begin_time" => "1462860000", //课程开始时间
                "end_time" => "1462969800", //课程结束时间
                "course_len" => 4800,
                ...
                "display_status" => 2,//1初始化 2正在招生 3 暂停招生 4满班 5 开课中 6 已完成 8审核中 12已失效 13班课终止 15进入教室 16即将开课 17线下班课进行中
                "total_pay" => 0,
                ...
                "succ_pay" => 5,
                "can_chaban" => false,//当前时间能否插班
                "realtime_price" => 12683.82, //实时价格
                "can_pay" => 10, //剩余人数
                "is_full" => false, // 是否满班
                "over_close_time" => 0,
                "freq" => 12,//课次数
