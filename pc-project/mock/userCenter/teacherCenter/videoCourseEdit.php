        ...
        'tpl_data' => [
            ...
            "video_list" => array(
                ...
                array(
                    "id" => 1113,// 课节id
                    "video_id" => 1231,//视频id
                    "title" => "微信营销第三课：一键呼出微信窗口，实时提醒新消息，方便好用。更有豪礼大奖活动进行！", // 课节标题
                    "file_name" => "黑猫警长.mp4",
                ...
                array(
                    "id" => 1114,// 课节id
                    "video_id" => 1231,//视频id
                    "title" => "微信营销第四课：微信是腾讯公司基于QQ开发的一种可以用语音说的软件,不过手机是智能机才可以用的微信是腾讯公司基于QQ开发的一种可以用语音说的软件,不过手机是智能机才可以用的", // 课节标题
                    "file_name" => "黑猫警长.mp4",
                    "type" => 1, //1 免费课节 2 试听课节 3付费课节
                    //时长这个待定最后来做
                    "video_status" => 4, //表示检查及审核状态, 0成功 1视频检查中 2视频检查失败 3审核中 4审核失败
                ...
                array(
                    "id" => 1115,// 课节id
                    "video_id" => 1231,//视频id
                    "title" => "微信营销第五课：总是对着手机看微信是不是觉得屏幕太小不是特别方便", // 课节标题
                    "file_name" => "黑猫警长.mp4",
                    "type" => 1, //1 免费课节 2 试听课节 3付费课节
                    //时长这个待定最后来做
                    "video_status" => 4, //表示检查及审核状态, 0成功 1视频检查中 2视频检查失败 3审核中 4审核失败
