...
render(
    ...
    array(
        "tpl_data" => array(
            ...
            "qid" => '123123',
            "abtest" => 0, // abtest...已废
            "city_pinyin" => 'songyuan', // 随abtest一起作废
            'hit_tag' => array(
                'course1'=>array(
                    'name'  => '艺术',
                    'id'    => '1',
            ...
            'famous_teachers' => array( // 城市英雄：本地名师＋全国名师
                'single_famous_teachers' => array( // 单独显示老师
                    array(
                        'is_local_famous' => false, // true本地名师；false全国名师
                        'is_local' => false, // 是否是本地老师
                        "id" => "11111",
                        "ad_title" => "本地名师",
                        "private_domain" => 'bj.genshuixue.com',
                        "course_type" => 13,
                        "location" => '北京',
                        "vip_level" => 3, // 0非会员 1普通会员 2高级会员 3超级会员
                        "name" => "张三李四",
                        "detail_url" => "bj.genshuixue.com",
                        "avatar_url" => "http://img.gsxservice.com/2076880_pu7emoyb.jpeg",
                        "online_stat" => 1,
                        "organization_name" => "了失衡恩",
                        "tag" => array(
                            array(
                                "name"=>"认真负责"
                            ),
                ...
                'aggregation_famous_teachers' => array( // 聚合显示老师
                    array(
                        'is_local_famous' => true, // true本地名师；false全国名师
                        'is_local' => false, // 是否是本地老师
                        "private_domain" => 'bj.genshuixue.com',
                        "id" => "11111",
                        "ad_title" => "本地名师",
                ...
                'general_famous_teachers' => array( // 聚合显示老师
                    "pos" => 3,
                    "res" => array(
                        array(
                            'is_local_famous' => true, // true本地名师；false全国名师
            ...
            'teachers' => array(// 教师数据
                ...
                array(
                    ...
                    'student_count' => 1, //
                    'has_course' => 0 ,//是否有一对一决定是否显示价格
                    'has_free_class_course' => 1, //是否有免费班课
                    'has_free_video_course' => 1, //是否有免费视频课
                ),
                array(
                    "score"=>"5.0",
                    "comment_count"=>"",
                    ...
                    'student_count' => 1, //
                    'has_course' => 0 ,//是否有一对一决定是否显示价格
                    'has_free_class_course' => 0, //是否有免费班课
                    'has_free_video_course' => 0, //是否有免费视频课
                ),
                array(
                    "score"=>"5.0",
                    "comment_count"=>"",
            ...
            'relatedcourse' => array(// 相关课程
                array(
                    'pic' => '123', //课程图片
                    'name' => '沈佳宜1dshjjdsfjsakndmfkjsda,mfnajkmds', //课程名称
                    'price' => 243 ,     //课程价格
                    'detail_url' => 'xxx',//课程地址
            ...
            'q'=>'语-文-阿斯顿离开-拉萨的看法---阿隆索的会计法',//搜索query
            'category' => '分类关键词',
            'seoCategory' => '艺术培训',
            'keywords' => '海淀区, 男, 上门教学',
            'title' => '北京 数学 老师-跟谁学',
