...
define(function (require) {
    ...
    AddressForm.prototype = {
        ...
        init: function () {
            ...
            new AutoComplete({
                ...
                onItemClick: function (e) {
                    ...
                    var formElement = $('.form .inland-address');
                    ...
                    formElement.find('textarea[name="detailed_address"]').focus();
            ...
            me.detailedAddressInput = new Text({
                element: element.find('[name="detailed_address"]')
            });
        },
        ...
        refresh: function (data) {
            ...
            // detailed_address
            me.detailedAddressInput.setValue(
