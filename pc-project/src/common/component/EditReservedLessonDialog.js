...
define(function (require, exports) {
     ...
     */
    function EditReservedLessonDialog(options) {
        $.extend(this, options);
        this.init();
    }
    ...
    EditReservedLessonDialog.prototype = {
        ...
        init: function () {
            ...
            // tooltip
            new Tooltip({
                element: element.find('.lesson-info .name')
            });
    ...
    var dialogTpl = etpl.compile(''
        ...
        +             '<p class="name" data-title="${courseName}" data-width="20em">课程名称：${courseName}</p>'
        +             '<p>'
        +             '<!-- if: ${userType} == 2 -->'
        +                 '老师：'
        +             '<!-- elif: ${userType} == 0 -->'
    ...
    return EditReservedLessonDialog;
});
