...
define(function (require, exports, module) {
    ...
    **/
    ...
    return Ractive.extend({
        template: require('html!./OfflineCourseSetting.html'),
        data: function () {
            return {
                style: require('text!./OfflineCourseSetting.styl'),
                ...
                compatiblePrice: CLASS_CHABAN_PRICE_RESET,
                    ...
                    if (oldRule != null) {
                        alert({
                            ...
                            content: '注意：设置了保底开班后，当报名学生人数没有达到最低开班人数时，'
                                + '开班前1天将会自动关班，所有已报名学生将自动退款。请确认是否设置',
                            buttons: [
                                {
                                    text: '确定',
                                    type: 'primary',
