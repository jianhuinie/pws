...
课程设置 - 课时优惠包 <?php if (isset($_smarty_tpl->tpl_vars['tpl_data']->value['huike']['is_huike_student'])&&$_smarty_tpl->tpl_vars['tpl_data']->value['huike']['is_huike_student']) {?> 汇课间
<?php } else { ?> 跟谁学
<?php }?>
...
/src/css/teacherCenter/courseCombo.less">
...
$_tpl_stack[] = $_smarty_tpl; $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate("common/upgrade.html", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0, '200123397658db6e5b2816f5-51662663');
content_58db6e5b335485_83042519($_smarty_tpl);
...
$_tpl_stack[] = $_smarty_tpl; $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate("rave/ravebanner.html", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0, '200123397658db6e5b2816f5-51662663');
content_58db6e5b3380c2_58376949($_smarty_tpl);
...
$_tpl_stack[] = $_smarty_tpl; $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate("common/component/flotage.html", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0, '200123397658db6e5b2816f5-51662663');
content_58db6e5b33e7a1_43460427($_smarty_tpl);
...
$_tpl_stack[] = $_smarty_tpl; $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate("common/siteNav.html", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0, '200123397658db6e5b2816f5-51662663');
content_58db6e5b342457_01414780($_smarty_tpl);
...
$_tpl_stack[] = $_smarty_tpl; $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate("common/center/common/header.html", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0, '200123397658db6e5b2816f5-51662663');
content_58db6e5b3438f0_42002501($_smarty_tpl);
...
$_tpl_stack[] = $_smarty_tpl; $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate("common/center/common/nav.html", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0, '200123397658db6e5b2816f5-51662663');
content_58db6e5b34c009_17828983($_smarty_tpl);
...
$_tpl_stack[] = $_smarty_tpl; $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate("teacher_center/common/sidebar.html", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('active'=>"course"), 0, '200123397658db6e5b2816f5-51662663');
content_58db6e5b36b240_23291439($_smarty_tpl);
$_smarty_tpl = array_pop($_tpl_stack); /* End of included template "teacher_center/common/sidebar.html" */?><div id="content" class="card"><div class="card-header"><a href="/teacher_course/list_admin">课程设置</a>&nbsp;&gt;&nbsp;<a>课时优惠包</a></div><div class="card-body"><div class="course-combo"><?php if (count($_smarty_tpl->tpl_vars['tpl_data']->value['combo_list'])<$_smarty_tpl->tpl_vars['tpl_data']->value['combo_quota']) {?><div class="form-trigger"><div class="create-combo edit"><i class="icon icon-round-add"></i>添加课时优惠包</div><p>课时优惠包适用于你提供的所有授课科目，合理的折扣能够吸引学生购买更多课时，建议越长的课时优惠包提供越大的折扣哦！</p></div><?php }?><?php /* Call merged included template "teacher_center/course/comboForm.html" */
$_tpl_stack[] = $_smarty_tpl; $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate("teacher_center/course/comboForm.html", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0, '200123397658db6e5b2816f5-51662663');
content_58db6e5b481d76_40369714($_smarty_tpl);
$_smarty_tpl = array_pop($_tpl_stack); /* End of included template "teacher_center/course/comboForm.html" */?><?php $_smarty_tpl->tpl_vars['item'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['item']->_loop = false; $_from = $_smarty_tpl->tpl_vars['tpl_data']->value['combo_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['item']->key => $_smarty_tpl->tpl_vars['item']->value) {
$_smarty_tpl->tpl_vars['item']->_loop = true;
?><div class="combo form-trigger" data-combo='<?php echo json_encode($_smarty_tpl->tpl_vars['item']->value);?>
'><div class="action"><i class="icon edit">编辑</i><i class="icon remove">删除</i></div><i class="icon icon-combo-blue"></i><div class="info"><span class="time"><?php echo $_smarty_tpl->tpl_vars['item']->value['hours'];?>
小时</span><span class="discount"><?php if ($_smarty_tpl->tpl_vars['item']->value['discount']==0) {?>免费<?php } elseif ($_smarty_tpl->tpl_vars['item']->value['discount']==10) {?>无折扣<?php } else { ?><?php echo $_smarty_tpl->tpl_vars['item']->value['discount'];?> 折<?php }?></span><?php if (isset($_smarty_tpl->tpl_vars['item']->value['verify_status'])&&$_smarty_tpl->tpl_vars['item']->value['verify_status']==2) {?><div class="message message-error"><i class="icon icon-info-circle"></i>本课时优惠包设置有问题哦，快修改一下吧！</div><?php }?><span class="name"><?php echo smarty_modifier_cn_truncate($_smarty_tpl->tpl_vars['item']->value['name'],20);?>
</span></div></div><?php /* Call merged included template "teacher_center/course/comboForm.html" */
$_tpl_stack[] = $_smarty_tpl; $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate("teacher_center/course/comboForm.html", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0, '200123397658db6e5b2816f5-51662663');
content_58db6e5b481d76_40369714($_smarty_tpl);
$_smarty_tpl = array_pop($_tpl_stack); /* End of included template "teacher_center/course/comboForm.html" */?><?php } ?><div class="go-back"><a class="btn btn-default" href="/teacher_course/list_admin">返回课程设置</a></div></div></div></div> </div> <?php /* Call merged included template "common/script.html" */
$_tpl_stack[] = $_smarty_tpl; $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate("common/script.html", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0, '200123397658db6e5b2816f5-51662663');
content_58db6e5b4984d9_92730217($_smarty_tpl);
...
$_tpl_stack[] = $_smarty_tpl; $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate("common/footer.html", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0, '200123397658db6e5b2816f5-51662663');
content_58db6e5b4bfff6_18229515($_smarty_tpl);
...
<?php /* Smarty version Smarty-3.1.19, created on 2017-03-29 16:20:43 compiled from "/Users/bjhl/workspace/web-fe/view/common/upgrade.html" */ ?>
<?php if ($_valid && !is_callable('content_58db6e5b335485_83042519')) {function content_58db6e5b335485_83042519($_smarty_tpl) {?> <!--[if lt IE 8]><div class="browser-upgrade"><div class="wrapper">您的浏览器版本过低，为了保证更好的安全性和浏览体验，建议更换高级浏览器，如：<a href="http://www.baidu.com/s?wd=谷歌浏览器">谷歌浏览器</a><a href="http://www.baidu.com/s?wd=火狐浏览器">火狐浏览器</a><a href="http://www.baidu.com/s?wd=360极速浏览器">360 极速浏览器</a></div></div><style>body {padding-top: 40px;}.browser-upgrade {background-color: #DA7575;border-bottom: 1px solid #D65F39;color: #F0F0F0;padding: 10px 0;position: absolute;top: 0;left: 0;width: 100%;z-index: 10000;}.browser-upgrade .wrapper {width: 1100px;margin: 0 auto;}.browser-upgrade a {color: yellow;margin-right: 10px;text-decoration: underline;}</style><![endif]--><?php }} ?>
<?php /* Smarty version Smarty-3.1.19, created on 2017-03-29 16:20:43 compiled from "/Users/bjhl/workspace/web-fe/view/rave/ravebanner.html" */ ?>
<?php if ($_valid && !is_callable('content_58db6e5b3380c2_58376949')) {function content_58db6e5b3380c2_58376949($_smarty_tpl) {?><div id="ravebanner" class="hiderave" data-href="<?php echo $_smarty_tpl->tpl_vars['rave_activity_host']->value;?>
...
$_tpl_stack[] = $_smarty_tpl; $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate("rave/round.html", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0, '200123397658db6e5b2816f5-51662663');
content_58db6e5b339b21_19604920($_smarty_tpl);
$_smarty_tpl = array_pop($_tpl_stack); /* End of included template "rave/round.html" */?></div></div></div><?php }} ?>
<?php /* Smarty version Smarty-3.1.19, created on 2017-03-29 16:20:43 compiled from "/Users/bjhl/workspace/web-fe/view/rave/round.html" */ ?>
<?php if ($_valid && !is_callable('content_58db6e5b339b21_19604920')) {function content_58db6e5b339b21_19604920($_smarty_tpl) {?><div class="round-wrapper" id="raveRound"><div class="round-list"><div class="round-prev"><span class="icon icon-chevron-left"></span></div><div class="round-item first disabled" data-index="0" data-key="dxzc"><div class="round-bg"><img src="<?php echo $_smarty_tpl->tpl_vars['static_origin']->value;?>
...
<?php /* Smarty version Smarty-3.1.19, created on 2017-03-29 16:20:43 compiled from "/Users/bjhl/workspace/web-fe/view/common/component/flotage.html" */ ?>
<?php if ($_valid && !is_callable('content_58db6e5b33e7a1_43460427')) {function content_58db6e5b33e7a1_43460427($_smarty_tpl) {?>
...
<?php /* Smarty version Smarty-3.1.19, created on 2017-03-29 16:20:43 compiled from "/Users/bjhl/workspace/web-fe/view/common/siteNav.html" */ ?>
<?php if ($_valid && !is_callable('content_58db6e5b342457_01414780')) {function content_58db6e5b342457_01414780($_smarty_tpl) {?>
<div id="site-nav"><div class="wrapper"></div></div><?php }} ?>
<?php /* Smarty version Smarty-3.1.19, created on 2017-03-29 16:20:43 compiled from "/Users/bjhl/workspace/web-fe/view/common/center/common/header.html" */ ?>
<?php if ($_valid && !is_callable('content_58db6e5b3438f0_42002501')) {function content_58db6e5b3438f0_42002501($_smarty_tpl) {?> <div id="header"><div class="wrapper"><?php if ((isset($_smarty_tpl->tpl_vars['tpl_data']->value['is_huike_teacher'])&&$_smarty_tpl->tpl_vars['tpl_data']->value['is_huike_teacher'])||(isset($_smarty_tpl->tpl_vars['tpl_data']->value['huike']['is_huike_student'])&&$_smarty_tpl->tpl_vars['tpl_data']->value['huike']['is_huike_student'])) {?><a class="logo-huikejian"></a><?php } else { ?><a class="logo" href="<?php echo $_smarty_tpl->tpl_vars['origin_http']->value;?>
...
<?php /* Smarty version Smarty-3.1.19, created on 2017-03-29 16:20:43 compiled from "/Users/bjhl/workspace/web-fe/view/common/center/common/nav.html" */ ?>
<?php if ($_valid && !is_callable('content_58db6e5b34c009_17828983')) {function content_58db6e5b34c009_17828983($_smarty_tpl) {?>
...
<?php /* Smarty version Smarty-3.1.19, created on 2017-03-29 16:20:43 compiled from "/Users/bjhl/workspace/web-fe/view/teacher_center/common/sidebar.html" */ ?>
<?php if ($_valid && !is_callable('content_58db6e5b36b240_23291439')) {function content_58db6e5b36b240_23291439($_smarty_tpl) {?> <?php $_smarty_tpl->createLocalArrayVariable('manageOverview', null, 0);
...
$_tpl_stack[] = $_smarty_tpl; $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate("common/center/common/sidebar.html", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('menu'=>$_smarty_tpl->tpl_vars['menu']->value), 0, '200123397658db6e5b2816f5-51662663');
content_58db6e5b408807_78137505($_smarty_tpl);
$_smarty_tpl = array_pop($_tpl_stack); /* End of included template "common/center/common/sidebar.html" */?> <?php }} ?>
<?php /* Smarty version Smarty-3.1.19, created on 2017-03-29 16:20:43 compiled from "/Users/bjhl/workspace/web-fe/view/common/center/common/sidebar.html" */ ?>
<?php if ($_valid && !is_callable('content_58db6e5b408807_78137505')) {function content_58db6e5b408807_78137505($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_cn_truncate')) include '/Users/bjhl/workspace/web-fe/mock/smarty/plugins/modifier.cn_truncate.php';
...
$_tpl_stack[] = $_smarty_tpl; $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate("common/component/image.html", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('url'=>$_smarty_tpl->tpl_vars['user_data']->value['avatar'],'width'=>58,'class'=>"thumbnail small"), 0, '200123397658db6e5b2816f5-51662663');
content_58db6e5b40f222_15423263($_smarty_tpl);
...
<?php /* Smarty version Smarty-3.1.19, created on 2017-03-29 16:20:43 compiled from "/Users/bjhl/workspace/web-fe/view/common/component/image.html" */ ?>
<?php if ($_valid && !is_callable('content_58db6e5b40f222_15423263')) {function content_58db6e5b40f222_15423263($_smarty_tpl) {?>
...
"<?php }?>/><?php }?>
<?php }} ?>
<?php /* Smarty version Smarty-3.1.19, created on 2017-03-29 16:20:43 compiled from "/Users/bjhl/workspace/web-fe/view/teacher_center/course/comboForm.html" */ ?>
<?php if ($_valid && !is_callable('content_58db6e5b481d76_40369714')) {function content_58db6e5b481d76_40369714($_smarty_tpl) {?> <div class="form combo-form"><div class="form-group"><label class="form-label"><i class="form-required"></i>简介：</label><div class="form-controls"><input class="form-text <?php if (isset($_smarty_tpl->tpl_vars['item']->value['verify_status'])&&$_smarty_tpl->tpl_vars['item']->value['verify_status']==2) {?>form-error<?php }?>" type="text" name="name" placeholder="请输入简介" required minlength="2" maxlength="15" /><span class="error"></span><?php if (isset($_smarty_tpl->tpl_vars['item']->value['verify_status'])&&$_smarty_tpl->tpl_vars['item']->value['verify_status']==2) {?><div class="reasons form-block"><i class="icon icon-info-circle"></i><?php $_smarty_tpl->tpl_vars['reason'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['reason']->_loop = false; $_from = $_smarty_tpl->tpl_vars['item']->value['reasons']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
...
；<?php } ?></div><?php }?></div></div><div class="form-group"><label class="form-label"><i class="form-required"></i>时长：</label><div class="form-controls"><input class="form-text" type="text" name="hours" placeholder="请输入时长" required min="1" max="999" pattern="^[\d]+$" /><div class="form-static form-inline form-hint"><i class="icon icon-info-circle"></i>请输入 1-999 的整数</div><span class="error"></span></div></div><div class="form-group"><label class="form-label">折扣：</label><div class="form-controls"><div class="form-number"><input class="form-text" type="text" name="discount" pattern="^[1-9]\.?[0-9]?$" placeholder="请输入折扣" min="1" max="9.9" step="0.1" /><i class="icon icon-caret-up"></i><i class="icon icon-caret-down"></i></div><div class="form-static form-inline form-hint"><i class="icon icon-info-circle"></i>请输入 1-9.9 对应 1-9.9 折，不填写表示没有折扣</div><span class="error"></span></div></div><div class="form-action"><button class="btn btn-primary">保存</button><button class="btn btn-default">取消</button></div></div><?php }} ?>
<?php /* Smarty version Smarty-3.1.19, created on 2017-03-29 16:20:43 compiled from "/Users/bjhl/workspace/web-fe/view/common/script.html" */ ?>
<?php if ($_valid && !is_callable('content_58db6e5b4984d9_92730217')) {function content_58db6e5b4984d9_92730217($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_replace')) include '/Users/bjhl/workspace/web-fe/mock/smarty/plugins/modifier.replace.php';
?> <script src="<?php echo $_smarty_tpl->tpl_vars['static_origin']->value;?>
...
<?php }} ?>
<?php /* Smarty version Smarty-3.1.19, created on 2017-03-29 16:20:43 compiled from "/Users/bjhl/workspace/web-fe/view/common/footer.html" */ ?>
<?php if ($_valid && !is_callable('content_58db6e5b4bfff6_18229515')) {function content_58db6e5b4bfff6_18229515($_smarty_tpl) {?> <div id="footer"><div class="wrapper"><div class="favor-links"><div class="tel"><i class="icon icon-phone"></i><h4>4000-910-910</h4><span>周一至周日&nbsp;9:00-23:00</span></div><div class="list"><h4>关注我们</h4><ul><li><span class="show-wechat">官方微信</span></li><li class="weibo"><a rel="nofollow" href="http://weibo.com/genshuixue" target="_blank">新浪微博</a></li><li><a rel="nofollow" href="<?php echo $_smarty_tpl->tpl_vars['root_http']->value;?>
