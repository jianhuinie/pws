...
$_smarty_tpl->tpl_vars['script_data']->value['cityDomain'] = $_smarty_tpl->tpl_vars['curr_city']->value['domain'];?> <?php $_smarty_tpl->tpl_vars['amd_more'] = new Smarty_variable(array('common/main/component/overview'), null, 0);?> <?php if ($_smarty_tpl->tpl_vars['user_data']->value['user_type']==0) {?> <?php $_smarty_tpl->tpl_vars['identity'] = new Smarty_variable("teacher", null, 0);?> <?php } else { ?> <?php $_smarty_tpl->tpl_vars['identity'] = new Smarty_variable("student", null, 0);?> <?php }?> <?php $_smarty_tpl->tpl_vars['page_class'] = new Smarty_variable(($_smarty_tpl->tpl_vars['identity']->value).('-center'), null, 0);?> <?php $_smarty_tpl->tpl_vars['script_path'] = new Smarty_variable("common/center/message", null, 0);?> <?php if (isset($_smarty_tpl->tpl_vars['tpl_data']->value['message_setting'])) {?> <?php $_smarty_tpl->createLocalArrayVariable('script_data', null, 0);
$_smarty_tpl->tpl_vars['script_data']->value['defaultSetting'] = $_smarty_tpl->tpl_vars['tpl_data']->value['message_setting']['default_setting'];?> <?php }?> <?php if (isset($_smarty_tpl->tpl_vars['tpl_data']->value['sys_messages']['list'])&&count($_smarty_tpl->tpl_vars['tpl_data']->value['sys_messages']['list'])>0) {?> <?php $_smarty_tpl->createLocalArrayVariable('script_data', null, 0);
$_smarty_tpl->tpl_vars['script_data']->value['eid'] = $_smarty_tpl->tpl_vars['tpl_data']->value['sys_messages']['list'][count($_smarty_tpl->tpl_vars['tpl_data']->value['sys_messages']['list'])-1]['msg_id'];?> <?php }?> <?php $_smarty_tpl->tpl_vars['nav_active_tab'] = new Smarty_variable('message', null, 0);?> <meta charset="utf-8" /><link rel="dns-prefetch" href="http://cdn.bootcss.com" /><link rel="dns-prefetch" href="http://apps.bdimg.com" /><link rel="dns-prefetch" href="http://su.bdimg.com" /><link rel="dns-prefetch" href="http://s1.bdstatic.com" /><link rel="dns-prefetch" href="http://api.map.baidu.com" /><link rel="dns-prefetch" href="http://storage.genshuixue.com" /><?php if ($_smarty_tpl->tpl_vars['need_im']->value) {?><link rel="stylesheet" href="<?php echo $_smarty_tpl->tpl_vars['static_origin']->value;?>
...
/src/css/common/center/message.less">
...
$_tpl_stack[] = $_smarty_tpl; $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate("common/upgrade.html", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0, '135835327857733b99a267d9-64735772');
content_57a2f0c1c0fe20_69816835($_smarty_tpl);
...
$_tpl_stack[] = $_smarty_tpl; $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate("rave/ravebanner.html", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0, '135835327857733b99a267d9-64735772');
content_57a2f0c1c13d18_27222761($_smarty_tpl);
...
$_tpl_stack[] = $_smarty_tpl; $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate("common/component/flotage.html", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0, '135835327857733b99a267d9-64735772');
content_57a2f0c1c1d803_59419702($_smarty_tpl);
...
$_tpl_stack[] = $_smarty_tpl; $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate("common/siteNav.html", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0, '135835327857733b99a267d9-64735772');
content_57a2f0c1c25993_61106848($_smarty_tpl);
...
$_tpl_stack[] = $_smarty_tpl; $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate("common/center/common/header.html", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0, '135835327857733b99a267d9-64735772');
content_57a2f0c1c29465_29410883($_smarty_tpl);
...
$_tpl_stack[] = $_smarty_tpl; $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate("common/center/common/nav.html", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0, '135835327857733b99a267d9-64735772');
content_57a2f0c1c2f208_96030131($_smarty_tpl);
...
$_tpl_stack[] = $_smarty_tpl; $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate("./common/sidebar.html", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('active'=>"message"), 0, '135835327857733b99a267d9-64735772');
content_57a2f0c1c48933_62369864($_smarty_tpl);
$_smarty_tpl = array_pop($_tpl_stack); /* End of included template "./common/sidebar.html" */?><div id="content" class="card"><div class="card-header"><h2>我的消息</h2></div><div class="card-body"><div class="tab"><div class="tab-nav-primary"><b class="nav-item active" data-panel="user">用户消息</b><b class="nav-item" data-panel="sys">系统通知</b><b class="nav-item" data-panel="setting">短信通知设置</b></div><div class="tab-content"><div class="tab-panel"></div><div class="tab-panel"></div><div class="tab-panel"><?php /* Call merged included template "teacher_center/message/setting.html" */
$_tpl_stack[] = $_smarty_tpl; $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate("teacher_center/message/setting.html", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0, '135835327857733b99a267d9-64735772');
content_57a2f0c1d53f24_73851817($_smarty_tpl);
$_smarty_tpl = array_pop($_tpl_stack); /* End of included template "teacher_center/message/setting.html" */?></div></div></div> </div> </div> </div> <?php /* Call merged included template "common/script.html" */
$_tpl_stack[] = $_smarty_tpl; $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate("common/script.html", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0, '135835327857733b99a267d9-64735772');
content_57a2f0c1d96bf0_64823796($_smarty_tpl);
...
$_tpl_stack[] = $_smarty_tpl; $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate("common/footer.html", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0, '135835327857733b99a267d9-64735772');
content_57a2f0c1dc48f3_47229546($_smarty_tpl);
...
<?php /* Smarty version Smarty-3.1.19, created on 2016-08-04 15:37:37 compiled from "/Users/bjhl/workspace/web-fe/view/common/upgrade.html" */ ?>
<?php if ($_valid && !is_callable('content_57a2f0c1c0fe20_69816835')) {function content_57a2f0c1c0fe20_69816835($_smarty_tpl) {?> <!--[if lt IE 8]><div class="browser-upgrade"><div class="wrapper">您的浏览器版本过低，为了保证更好的安全性和浏览体验，建议更换高级浏览器，如：<a href="http://www.baidu.com/s?wd=谷歌浏览器">谷歌浏览器</a><a href="http://www.baidu.com/s?wd=火狐浏览器">火狐浏览器</a><a href="http://www.baidu.com/s?wd=360极速浏览器">360 极速浏览器</a></div></div><style>body {padding-top: 40px;}.browser-upgrade {background-color: #DA7575;border-bottom: 1px solid #D65F39;color: #F0F0F0;padding: 10px 0;position: absolute;top: 0;left: 0;width: 100%;z-index: 10000;}.browser-upgrade .wrapper {width: 1100px;margin: 0 auto;}.browser-upgrade a {color: yellow;margin-right: 10px;text-decoration: underline;}</style><![endif]--><?php }} ?>
<?php /* Smarty version Smarty-3.1.19, created on 2016-08-04 15:37:37 compiled from "/Users/bjhl/workspace/web-fe/view/rave/ravebanner.html" */ ?>
<?php if ($_valid && !is_callable('content_57a2f0c1c13d18_27222761')) {function content_57a2f0c1c13d18_27222761($_smarty_tpl) {?><div id="ravebanner" class="hiderave" data-href="<?php echo $_smarty_tpl->tpl_vars['rave_activity_host']->value;?>
...
$_tpl_stack[] = $_smarty_tpl; $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate("rave/round.html", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0, '135835327857733b99a267d9-64735772');
content_57a2f0c1c168f4_19638640($_smarty_tpl);
$_smarty_tpl = array_pop($_tpl_stack); /* End of included template "rave/round.html" */?></div></div></div><?php }} ?>
<?php /* Smarty version Smarty-3.1.19, created on 2016-08-04 15:37:37 compiled from "/Users/bjhl/workspace/web-fe/view/rave/round.html" */ ?>
<?php if ($_valid && !is_callable('content_57a2f0c1c168f4_19638640')) {function content_57a2f0c1c168f4_19638640($_smarty_tpl) {?><div class="round-wrapper" id="raveRound"><div class="round-list"><div class="round-prev"><span class="icon icon-chevron-left"></span></div><div class="round-item first disabled" data-index="0" data-key="dxzc"><div class="round-bg"><img src="<?php echo $_smarty_tpl->tpl_vars['static_origin']->value;?>
...
<?php /* Smarty version Smarty-3.1.19, created on 2016-08-04 15:37:37 compiled from "/Users/bjhl/workspace/web-fe/view/common/component/flotage.html" */ ?>
<?php if ($_valid && !is_callable('content_57a2f0c1c1d803_59419702')) {function content_57a2f0c1c1d803_59419702($_smarty_tpl) {?>
...
<?php /* Smarty version Smarty-3.1.19, created on 2016-08-04 15:37:37 compiled from "/Users/bjhl/workspace/web-fe/view/common/siteNav.html" */ ?>
<?php if ($_valid && !is_callable('content_57a2f0c1c25993_61106848')) {function content_57a2f0c1c25993_61106848($_smarty_tpl) {?>
<div id="site-nav"><div class="wrapper"></div></div><?php }} ?>
<?php /* Smarty version Smarty-3.1.19, created on 2016-08-04 15:37:37 compiled from "/Users/bjhl/workspace/web-fe/view/common/center/common/header.html" */ ?>
<?php if ($_valid && !is_callable('content_57a2f0c1c29465_29410883')) {function content_57a2f0c1c29465_29410883($_smarty_tpl) {?> <div id="header"><div class="wrapper"><a class="logo" href="<?php echo $_smarty_tpl->tpl_vars['origin_http']->value;?>
...
<?php /* Smarty version Smarty-3.1.19, created on 2016-08-04 15:37:37 compiled from "/Users/bjhl/workspace/web-fe/view/common/center/common/nav.html" */ ?>
<?php if ($_valid && !is_callable('content_57a2f0c1c2f208_96030131')) {function content_57a2f0c1c2f208_96030131($_smarty_tpl) {?>
...
<?php /* Smarty version Smarty-3.1.19, created on 2016-08-04 15:37:37 compiled from "/Users/bjhl/workspace/web-fe/view/teacher_center/common/sidebar.html" */ ?>
<?php if ($_valid && !is_callable('content_57a2f0c1c48933_62369864')) {function content_57a2f0c1c48933_62369864($_smarty_tpl) {?> <?php $_smarty_tpl->createLocalArrayVariable('manageOverview', null, 0);
...
$_tpl_stack[] = $_smarty_tpl; $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate("common/center/common/sidebar.html", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('menu'=>$_smarty_tpl->tpl_vars['menu']->value), 0, '135835327857733b99a267d9-64735772');
content_57a2f0c1cd7d48_25300040($_smarty_tpl);
$_smarty_tpl = array_pop($_tpl_stack); /* End of included template "common/center/common/sidebar.html" */?> <?php }} ?>
<?php /* Smarty version Smarty-3.1.19, created on 2016-08-04 15:37:37 compiled from "/Users/bjhl/workspace/web-fe/view/common/center/common/sidebar.html" */ ?>
<?php if ($_valid && !is_callable('content_57a2f0c1cd7d48_25300040')) {function content_57a2f0c1cd7d48_25300040($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_cn_truncate')) include '/Users/bjhl/workspace/web-fe/mock/smarty/plugins/modifier.cn_truncate.php';
...
$_tpl_stack[] = $_smarty_tpl; $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate("common/component/image.html", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('url'=>$_smarty_tpl->tpl_vars['user_data']->value['avatar'],'width'=>58,'class'=>"thumbnail small"), 0, '135835327857733b99a267d9-64735772');
content_57a2f0c1ce2e96_38795532($_smarty_tpl);
...
<?php /* Smarty version Smarty-3.1.19, created on 2016-08-04 15:37:37 compiled from "/Users/bjhl/workspace/web-fe/view/common/component/image.html" */ ?>
<?php if ($_valid && !is_callable('content_57a2f0c1ce2e96_38795532')) {function content_57a2f0c1ce2e96_38795532($_smarty_tpl) {?>
...
"<?php }?>/><?php }?>
<?php }} ?>
<?php /* Smarty version Smarty-3.1.19, created on 2016-08-04 15:37:37 compiled from "/Users/bjhl/workspace/web-fe/view/teacher_center/message/setting.html" */ ?>
<?php if ($_valid && !is_callable('content_57a2f0c1d53f24_73851817')) {function content_57a2f0c1d53f24_73851817($_smarty_tpl) {?>
<div class="message-setting"><div class="header"><?php if ($_smarty_tpl->tpl_vars['tpl_data']->value['message_setting']['nodisturb']==1) {?><?php $_smarty_tpl->tpl_vars['class'] = new Smarty_variable('on', null, 0);?><?php $_smarty_tpl->tpl_vars['text'] = new Smarty_variable('已开启', null, 0);?><?php } else { ?><?php $_smarty_tpl->tpl_vars['class'] = new Smarty_variable('off', null, 0);?><?php $_smarty_tpl->tpl_vars['text'] = new Smarty_variable('未开启', null, 0);?><?php }?><div class="no-disturb <?php echo $_smarty_tpl->tpl_vars['class']->value;?>
">免打扰时段设置：<span class="switcher"><strong><?php echo $_smarty_tpl->tpl_vars['text']->value;?>
</strong><i></i></span><?php $_smarty_tpl->tpl_vars['parts'] = new Smarty_variable(explode('-',$_smarty_tpl->tpl_vars['tpl_data']->value['message_setting']['nodisturbtime']), null, 0);?><?php $_smarty_tpl->tpl_vars['start_time'] = new Smarty_variable($_smarty_tpl->tpl_vars['parts']->value[0], null, 0);?><?php $_smarty_tpl->tpl_vars['end_time'] = new Smarty_variable($_smarty_tpl->tpl_vars['parts']->value[1], null, 0);?><span class="time-duration"><span class="start-time"><?php echo $_smarty_tpl->tpl_vars['start_time']->value;?>
</span>-<span class="end-time"><?php echo $_smarty_tpl->tpl_vars['end_time']->value;?>
</span></span><b class="link edit-time">修改</b></div>勾选后将会收到对应的短信通知</div><div class="body"><table class="table"><tbody><tr><td><i class="icon icon-list-o"></i><strong>订单通知</strong><small>（一对一）</small></td><td><?php $_smarty_tpl->tpl_vars['setting'] = new Smarty_variable($_smarty_tpl->tpl_vars['tpl_data']->value['message_setting']['setting'], null, 0);?><?php /* Call merged included template "common/ui/checkbox.html" */
$_tpl_stack[] = $_smarty_tpl; $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate("common/ui/checkbox.html", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('text'=>"新增待支付订单",'name'=>"submit_order",'checked'=>in_array('submit_order',$_smarty_tpl->tpl_vars['setting']->value)), 0, '135835327857733b99a267d9-64735772');
content_57a2f0c1d60406_94535535($_smarty_tpl);
...
$_tpl_stack[] = $_smarty_tpl; $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate("common/ui/checkbox.html", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('text'=>"新增已支付订单",'name'=>"pay_order",'checked'=>in_array('pay_order',$_smarty_tpl->tpl_vars['setting']->value)), 0, '135835327857733b99a267d9-64735772');
content_57a2f0c1d60406_94535535($_smarty_tpl);
$_smarty_tpl = array_pop($_tpl_stack); /* End of included template "common/ui/checkbox.html" */?><?php /* Call merged included template "common/ui/checkbox.html" */
$_tpl_stack[] = $_smarty_tpl; $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate("common/ui/checkbox.html", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('text'=>"订单取消",'name'=>"cancel_order",'checked'=>in_array('cancel_order',$_smarty_tpl->tpl_vars['setting']->value)), 0, '135835327857733b99a267d9-64735772');
content_57a2f0c1d60406_94535535($_smarty_tpl);
$_smarty_tpl = array_pop($_tpl_stack); /* End of included template "common/ui/checkbox.html" */?></td></tr><tr><td><i class="icon icon-file-o"></i><strong>课程通知</strong><small>（一对一）</small></td><td><?php /* Call merged included template "common/ui/checkbox.html" */
$_tpl_stack[] = $_smarty_tpl; $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate("common/ui/checkbox.html", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('text'=>"学生发起约课",'name'=>"reserve_course",'checked'=>in_array('reserve_course',$_smarty_tpl->tpl_vars['setting']->value)), 0, '135835327857733b99a267d9-64735772');
content_57a2f0c1d60406_94535535($_smarty_tpl);
$_smarty_tpl = array_pop($_tpl_stack); /* End of included template "common/ui/checkbox.html" */?><?php /* Call merged included template "common/ui/checkbox.html" */
$_tpl_stack[] = $_smarty_tpl; $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate("common/ui/checkbox.html", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('text'=>"学生确认约课",'name'=>"confirm_course",'checked'=>in_array('confirm_course',$_smarty_tpl->tpl_vars['setting']->value)), 0, '135835327857733b99a267d9-64735772');
content_57a2f0c1d60406_94535535($_smarty_tpl);
$_smarty_tpl = array_pop($_tpl_stack); /* End of included template "common/ui/checkbox.html" */?><?php /* Call merged included template "common/ui/checkbox.html" */
$_tpl_stack[] = $_smarty_tpl; $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate("common/ui/checkbox.html", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('text'=>"课程取消",'name'=>"cancel_course",'checked'=>in_array('cancel_course',$_smarty_tpl->tpl_vars['setting']->value)), 0, '135835327857733b99a267d9-64735772');
content_57a2f0c1d60406_94535535($_smarty_tpl);
$_smarty_tpl = array_pop($_tpl_stack); /* End of included template "common/ui/checkbox.html" */?><?php /* Call merged included template "common/ui/checkbox.html" */
$_tpl_stack[] = $_smarty_tpl; $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate("common/ui/checkbox.html", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('text'=>"课前 1 天通知",'name'=>"remind_1day_before",'checked'=>in_array('remind_1day_before',$_smarty_tpl->tpl_vars['setting']->value)), 0, '135835327857733b99a267d9-64735772');
content_57a2f0c1d60406_94535535($_smarty_tpl);
$_smarty_tpl = array_pop($_tpl_stack); /* End of included template "common/ui/checkbox.html" */?><?php /* Call merged included template "common/ui/checkbox.html" */
$_tpl_stack[] = $_smarty_tpl; $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate("common/ui/checkbox.html", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('text'=>"课前 1 小时通知",'name'=>"remind_1hour_before",'checked'=>in_array('remind_1hour_before',$_smarty_tpl->tpl_vars['setting']->value)), 0, '135835327857733b99a267d9-64735772');
content_57a2f0c1d60406_94535535($_smarty_tpl);
$_smarty_tpl = array_pop($_tpl_stack); /* End of included template "common/ui/checkbox.html" */?></td></tr><tr><td><i class="icon icon-file-o"></i><strong>班课通知</strong></td><td><?php /* Call merged included template "common/ui/checkbox.html" */
$_tpl_stack[] = $_smarty_tpl; $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate("common/ui/checkbox.html", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('text'=>"新增待支付订单",'name'=>"submit_class_order",'checked'=>in_array('submit_class_order',$_smarty_tpl->tpl_vars['setting']->value)), 0, '135835327857733b99a267d9-64735772');
content_57a2f0c1d60406_94535535($_smarty_tpl);
$_smarty_tpl = array_pop($_tpl_stack); /* End of included template "common/ui/checkbox.html" */?><?php /* Call merged included template "common/ui/checkbox.html" */
$_tpl_stack[] = $_smarty_tpl; $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate("common/ui/checkbox.html", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('text'=>"新增已支付订单",'name'=>"pay_class_order",'checked'=>in_array('pay_class_order',$_smarty_tpl->tpl_vars['setting']->value)), 0, '135835327857733b99a267d9-64735772');
content_57a2f0c1d60406_94535535($_smarty_tpl);
$_smarty_tpl = array_pop($_tpl_stack); /* End of included template "common/ui/checkbox.html" */?><?php /* Call merged included template "common/ui/checkbox.html" */
$_tpl_stack[] = $_smarty_tpl; $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate("common/ui/checkbox.html", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('text'=>"订单取消",'name'=>"cancel_class_order",'checked'=>in_array('cancel_class_order',$_smarty_tpl->tpl_vars['setting']->value)), 0, '135835327857733b99a267d9-64735772');
content_57a2f0c1d60406_94535535($_smarty_tpl);
$_smarty_tpl = array_pop($_tpl_stack); /* End of included template "common/ui/checkbox.html" */?><?php /* Call merged included template "common/ui/checkbox.html" */
$_tpl_stack[] = $_smarty_tpl; $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate("common/ui/checkbox.html", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('text'=>"满班",'name'=>"full_class",'checked'=>in_array('full_class',$_smarty_tpl->tpl_vars['setting']->value)), 0, '135835327857733b99a267d9-64735772');
content_57a2f0c1d60406_94535535($_smarty_tpl);
$_smarty_tpl = array_pop($_tpl_stack); /* End of included template "common/ui/checkbox.html" */?></td></tr><tr><td><i class="icon icon-message-o"></i><strong>消息通知</strong></td><td><?php /* Call merged included template "common/ui/checkbox.html" */
$_tpl_stack[] = $_smarty_tpl; $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate("common/ui/checkbox.html", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('text'=>"有人给你发离线消息",'name'=>"receive_offline_message",'checked'=>in_array('receive_offline_message',$_smarty_tpl->tpl_vars['setting']->value)), 0, '135835327857733b99a267d9-64735772');
content_57a2f0c1d60406_94535535($_smarty_tpl);
$_smarty_tpl = array_pop($_tpl_stack); /* End of included template "common/ui/checkbox.html" */?><small>有人给你发送离线消息时你会收到短信提醒，同一个联系人的消息通知系统每天最多发送一次</small></td></tr><tr><td><i class="icon icon-rmb-o"></i><strong>资金通知</strong></td><td><?php /* Call merged included template "common/ui/checkbox.html" */
$_tpl_stack[] = $_smarty_tpl; $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate("common/ui/checkbox.html", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('text'=>"课酬已到平台账户",'name'=>"pay_course",'checked'=>in_array('pay_course',$_smarty_tpl->tpl_vars['setting']->value)), 0, '135835327857733b99a267d9-64735772');
content_57a2f0c1d60406_94535535($_smarty_tpl);
$_smarty_tpl = array_pop($_tpl_stack); /* End of included template "common/ui/checkbox.html" */?></td></tr><tr><td><i class="icon icon-deduct"></i><strong>扣分通知</strong></td><td><?php /* Call merged included template "common/ui/checkbox.html" */
$_tpl_stack[] = $_smarty_tpl; $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate("common/ui/checkbox.html", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('text'=>"扣分增加通知",'name'=>"deduct_point",'checked'=>in_array('deduct_point',$_smarty_tpl->tpl_vars['setting']->value)), 0, '135835327857733b99a267d9-64735772');
content_57a2f0c1d60406_94535535($_smarty_tpl);
$_smarty_tpl = array_pop($_tpl_stack); /* End of included template "common/ui/checkbox.html" */?><?php /* Call merged included template "common/ui/checkbox.html" */
$_tpl_stack[] = $_smarty_tpl; $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate("common/ui/checkbox.html", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('text'=>"惩罚状态解除",'name'=>"deduct_punishment_remove",'checked'=>in_array('deduct_punishment_remove',$_smarty_tpl->tpl_vars['setting']->value)), 0, '135835327857733b99a267d9-64735772');
content_57a2f0c1d60406_94535535($_smarty_tpl);
$_smarty_tpl = array_pop($_tpl_stack); /* End of included template "common/ui/checkbox.html" */?></td></tr></tbody></table></div><div class="footer"><b class="link recovery">恢复默认设置</b><b class="link notify-all">全部通知</b><b class="link notify-none">全部不通知</b><div><div class="btn-primary save-setting">保存</div></div></div></div><?php }} ?>
<?php /* Smarty version Smarty-3.1.19, created on 2016-08-04 15:37:37 compiled from "/Users/bjhl/workspace/web-fe/view/common/ui/checkbox.html" */ ?>
<?php if ($_valid && !is_callable('content_57a2f0c1d60406_94535535')) {function content_57a2f0c1d60406_94535535($_smarty_tpl) {?>
...
<?php /* Smarty version Smarty-3.1.19, created on 2016-08-04 15:37:37 compiled from "/Users/bjhl/workspace/web-fe/view/common/script.html" */ ?>
<?php if ($_valid && !is_callable('content_57a2f0c1d96bf0_64823796')) {function content_57a2f0c1d96bf0_64823796($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_replace')) include '/Users/bjhl/workspace/web-fe/mock/smarty/plugins/modifier.replace.php';
?> <script src="<?php echo $_smarty_tpl->tpl_vars['static_origin']->value;?>
