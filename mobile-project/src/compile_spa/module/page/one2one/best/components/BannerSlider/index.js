define(function (require, exports) {
    ...
    var BannerSlider = function (_React$Component) {
        _inherits(BannerSlider, _React$Component);
        function BannerSlider(props) {
            _classCallCheck(this, BannerSlider);
            var _this = _possibleConstructorReturn(this, (BannerSlider.__proto__ || Object.getPrototypeOf(BannerSlider)).call(this, props));
        ...
        _createClass(BannerSlider, [
            ...
            },
            {
                ...
                value: function initSlider() {
                    ...
                    var bullets = cContain.find('.slide_group li');
            ...
            },
            {
                ...
                value: function render() {
                    var self = this;
                    var dataList = self.props.banner;
