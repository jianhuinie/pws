define(function (require, exports) {
    ...
    var _routes = require('./liveHelp/routes');
    var _routes3 = require('./honorRank/routes');
    ...
    var App = function (_React$Component) {
        ...
        _createClass(App, [{
                ...
                value: function render() {
                    return _react2.default.createElement('div', { className: 'activity' }, this.props.children);
                }
            }]);
        return App;
