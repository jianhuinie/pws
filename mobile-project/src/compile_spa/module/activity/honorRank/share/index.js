        ...
        _createClass(PopularContainer, [
            ...
            },
            {
                ...
                value: function getList() {
                    ...
                    if (ajaxFlag) {
                        ...
                        service.get('/invite-card-activity/share-honor-rank', objects).then(function (res) {
                            if (+res.code === 0) {
                                var data = res.data;
                                var list = [];
                                if (type === 'reload') {
                                ...
                                var currentInfo = {};
                                currentInfo = data.current.weixin;
                                if (!currentInfo) {
                                    currentInfo = {};
                                }
                                var currentRank = {};
                                ...
                                var myItem = {
                                    img: currentInfo.headimgurl,
                                    name: currentInfo.nickname,
                                    order: currentRank.rank_order,
                                    invite_count: currentRank.invite_count,
                                    coupon: currentRank.coupon_count
                                };
                                self.setState({
                                    items: list,
                                    myItem: myItem,
            ...
            },
            {
                ...
                value: function render() {
                    app.setPageTitle('分享荣耀榜');
                    var type = 'share';
                    return _react2.default.createElement('div', { className: 'share-box' }, _react2.default.createElement('img', {
                        className: 'title-avatar',
                        'data-src': 'https://imgs.genshuixue.com/0cms/d/file/content/2017/05/591029033cfe0.png'
