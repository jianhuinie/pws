...
define(function (require) {
    ...
    var createVersion = (function () {
        function compare(ver1, ver2) {
            ...
            for (var c = 0; c < ver1.length || c < ver2.length; c++) {
                var d = parseInt(ver1[c], 10);
                var e = parseInt(ver2[c], 10);
                if (isNaN(d)) {
                    d = 0;
                }
                if (isNaN(e)) {
    ...
    function getPageSource() {
        var source = null;
        if (window.gsx_ready) {
            //这里可以保证是同步的,因为load在执行模块初始化之前会等report请求回来才执行
    ...
    function Env() {
        ...
        Object.defineProperty(this, "source", {
            get: function () {
                var sourceInfo = getPageSource();
                return sourceInfo ? sourceInfo.name : "";
            },
            enumerable: !0
        });

        Object.defineProperty(this, "source_id", {
            get: function () {
                var sourceInfo = getPageSource();
                return sourceInfo ? sourceInfo.id : "";
            },
            enumerable: !0
        });
