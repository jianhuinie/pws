...
{{block name="page"}}
    ...
    {{$page_module = "page/huikejian/newOrgCourse/newOrgCourse"}}
...
{{block name="style"}}
    <link rel="stylesheet" href="{{$static_origin}}/src/page/huikejian/newOrgCourse/newOrgCourse.styl"/>
{{/block}}
...
<div id="main">
    ...
    {{* 头图 *}}
    {{include file="../detail/header.tpl" type="course"}}
