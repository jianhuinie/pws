<div class="student-detail">
    ...
    {{$item = $tpl_data.item}}
    {{$teacherInfos = $tpl_data.joined_teachers_info}}
    {{$recommendCourses = $tpl_data.recommend_courses}}
    <div class="box">
        <div class="user-info">
            ...
            <div class="user-info-detail">
                <div class="first-nav">
                    <div class="course-icon clearfix">
                        ...
                        {{if isset($item.vip_exclusive_time) && $item.vip_exclusive_time > 0}}
        ...
        <div class="user-footer">
            ...
            {{if $item.display_status.name != "已关闭" && $tpl_data.is_own}}
    ...
    <div class="last-nav-has-teacher">
        <div class="first">
            <span>报名老师  ({{$teacherInfos|count}}/5)</span>
        </div>

        <div class="none-teacher {{if {{$teacherInfos|count}} != 0}} hide{{/if}}">
            {{if $tpl_data.is_own}}
                <p>
                    正在为您智能匹配老师，
                </p>
        ...
        <div class="teacher-infos" data-url="{{$teacher.home_url}}" data-index="1">
            <div class="teacher-box">
                ...
                <div class="teacher-info">
                    ...
                    <div class="last clearfix">
                        {{if empty($teacher.comment_summary)}}
                ...
                <!-- <div class="teacher-delete not-suit" data-number="{{$teacher.user_id}}"></div> -->
                <!-- 生源大厅3.0需求 改为点赞按钮 -->
                <!-- <div class="teacher-good"><img src="https://imgs.genshuixue.com/0cms/d/file/content/2017/01/586f793f4a4ab.png"></img>&nbsp;(30)</div> -->
    ...
    {{if $recommendCourses|count > 0 && $item.status != 3 && $item.verify_status != 0 && $item.verify_status != 2}}
