    ...
    <div class="box" data-href="/hall-teacher/get?number={{$item.number}}" data-click="11355">
        ...
        <div class="user-info">
            {{if isset($item.user) && !empty($item.user)}}
                <div class="user-image">
                    <img width="100%" src="{{$item.user.avatar_url_mobile}}@15w_15h_2x_70Q_0i_1e_1c_1wh_1pr.jpg">
                </div>
        ...
        <div class="last-nav">
            <div class="pay-teacher">
                报名老师({{if $item.joined_teachers|count > 5}}5{{else}}{{$item.joined_teachers|count}}{{/if}}/5)
            </div>
