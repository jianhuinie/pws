...
{{block name="page"}}
    ...
    {{$page_module = "page/CPS/sign_agreement/index"}}
...
{{block name="style"}}
    <link rel="stylesheet" href="{{$static_origin}}/src/page/CPS/sign_agreement/css/index.styl"/>
{{/block}}
    ...
    <div class="content-main">
        <div id="content-body" data-reactid=".0.1.1.1.0">
            ...
            <br>
                ...
                <br>
                <span>乙方：{{$ti.display_name}}</span>
                <br>
                {{*<span>证件号码：{{$ti.certificates_number}}</span>*}}
                <span>身份证号码：{{$ti.id_number}}</span>
                <br>
                <br>
                ...
                <br>
                <span>2、甲乙双方商定合作期限为1年。自{{$ti.start_time}}至{{$ti.end_time}}止。合作期限届满，双方拟继续合作的需另行签署协议。</span>
                <br>
                <br>
