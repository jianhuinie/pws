...
{{block name="page"}}
    ...
    {{$page_module = "page/k12_zhenti/k12Zhenti"}}
...
{{block name="style"}}
    <link rel="stylesheet" href="{{$static_origin}}/src/page/k12_zhenti/k12Zhenti.styl"/>
{{/block}}
...
<div class="fixed-icon">
    ...
    <div class="main-content">
        <div class="head">
            <img data-src="https://imgs.genshuixue.com/0cms/d/file/content/2016/04/572038f999848.png">
        ...
        <div class="class-content">
                        ...
                        <li>
                            <a href="{{$cCourse.url}}">
                                <div class="class-item">
                                    ...
                                    <div class="txt-info">
                                        <p class="title single-line">{{$cCourse.name}}</p>
                                        <p class="sub-title single-line">{{$cCourse.desc}}</p>
                                        <p class="sub-title single-line">{{$cCourse.teacher_name}}&nbsp;&nbsp;{{$cCourse.play_num}}次播放</p>
                                        <p class="bottom-txt price">
                                        ￥{{$cCourse.price}}元/套
                                        </p>
                                    </div>
                                </div>
            ...
            <div class="none-data-li">
                <div class="none-data-tip">
                    ...
                    <p>亲爱的同学，这里的真题视频还在准备中，过几天再来看看吧</p>
                </div>
            </div>
            {{/if}}
        ...
        <div class="fixed-footer on" style=" display:block; ">
            <div data-filter="kaodian" class="left part">
                <p style="background-position: center 0;" class="user-icon img">
                </p>
                <p class="single-line">
