    ...
    function moreListInit(){
        ...
        function getMoreList(page,done){
            ...
            require(["common/service"],function(service){
                ...
                service.get(
                    "/k12/choseBetterTeacher",
                    {
                        grade: urlParams.grade,
                        catname: urlParams.catname || "all",
                        subject_name: urlParams.subject_name || "全部",
                        curr_page: page,
                        render: "json"
                    },
                    function(res){
                        ...
                        if(res.code == "0"){
                            done && done(data.teacher_info_courses,data.page.has_more);
                        }else {
                            done && done(false);
                        }
                    }
