<div class="class-course-tags">
    ...
    {{/if}}
    {{*hurry:随时可退*}}
    {{if $tpl_data.course_info.tags|count > 0}}
    ...
    {{if $course_info.coupon_list|count > 0}}
        <div class="class-course-coupon analysis-habo-log" data-habo-type="{{$gsType}}" data-habo-stype="coupon">
            <span>
                <span class="icon-youhuijuan tag-icon-color tag-icon"></span>
                <span>领取优惠券</span>
            </span>
    ...
    {{/if}}
    {{*安全卫士的课显示安全卫士icon*}}
    {{if $tpl_data.course_info.is_safeguard==1}}
