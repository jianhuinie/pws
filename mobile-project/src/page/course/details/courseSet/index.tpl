...
{{block name="page"}}
    ...
    {{$page_module = "page/course/details/courseSet/index"}}
...
{{/block}}
{{block name="style"}}
    <link rel="stylesheet" href="{{$static_origin}}/src/page/course/details/courseSet/index.styl"/>
{{/block}}
{{block name="content"}}
    ...
    <div id="main">
        ...
        {{$briefIntro.courseInfo = $courseInfo.lesson_type_number|cat:"个课型可选"}}
        {{$briefIntro.courseInfoDetail = "随心选"}}
