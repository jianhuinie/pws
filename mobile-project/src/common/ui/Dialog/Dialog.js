...
define(function (require, exports) {
    ...
    observer.addListener(arrDialogs, 'length_changed', function () {
        ...
        if (length) {
            arrDialogs.token = util_dom.insertCssText(cssDialog);
    ...
    function Dialog(options) {
        ...
        this._closeBtnEvt = observer.addDomListener(closeButtonElement, 'click', util_function.bind(this.hide, this));
    ...
    util_base.inherits(Dialog, MVCObject);
    ...
    Dialog.prototype.title_changed = function () {
        ...
        if (util_base.isZepto(title) ||
            util_base.isDom(title) ||
            util_base.isString(title)) {
