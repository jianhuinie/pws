{{if !empty($teacher_info)}}
    <div class="teacher-list{{if $teacher_info|count == 1}} one{{/if}} analysis-habo-log-scroll" data-habo-type="{{$gsType}}" data-habo-stype="stteacher">
        <ul class="teacher-ul">
            {{foreach $teacher_info as $teacher}}
            <li class="detail-item teacher-item{{if $teacher_info|count == 1}} one-teacher{{/if}} analysis-habo-log" data-habo-type="{{$gsType}}" data-habo-stype="teacher">
                <div class="detail-title">老师介绍</div>
                <div class="detail-content">
                    <div class="teacher-info clearfix">

                        <div class="avatar{{if $teacher_info|count == 1}} w220{{/if}}">
