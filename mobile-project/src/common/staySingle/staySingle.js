        ...
        if (this.flagSingleTeacher) {
            ...
            $.post("/recommend/confirm_fill", params).always(function(res){
                ...
                if(res.code == "0"){
                    ui_new.alert({
                        title: '<span class="stay-dialog-title icon-check-o-org"></span>预约成功',
                        content:'课程顾问将尽快和您取得联系，请留意' + (params.channel.indexOf('youxuan') > -1 ? '来电信息' : '010-86448910来电。'),
                        width:280,
                        button:'确定'
                    });
                    savePhonetoAndriodApp();
                    ...
                    //重复提交
                    ui_new.confirm({
                        content:'您已经预约过了该老师的课程，请留意' + (params.channel.indexOf('youxuan') > -1 ? '来电信息' : '010-86448910来电。'),
                        button_cancel:'在线咨询',
                        width:280,
                        button_ok:'确定'
                    }).fail(function(){
